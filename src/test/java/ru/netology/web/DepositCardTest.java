...
class DepositCardTest {
    ...
    @Test
    void shouldCardFormInvalidWithEnglish() throws InterruptedException {

        driver.findElement(By.cssSelector("[data-test-id=name] input")).sendKeys("Konstantin"); //Имя на английском языке
        driver.findElement(By.cssSelector("[data-test-id=phone] input")).sendKeys("+79270000000");
        driver.findElement(By.cssSelector("[data-test-id=agreement]")).click();
        driver.findElement(By.className("button")).click();
    ...
    @Test
    void shouldCardFormInvalidPhone() throws InterruptedException {

        driver.findElement(By.cssSelector("[data-test-id=name] input")).sendKeys("Иван");
        driver.findElement(By.cssSelector("[data-test-id=phone] input")).sendKeys("79270000000"); //телефон без +
        driver.findElement(By.cssSelector("[data-test-id=agreement]")).click();
        driver.findElement(By.className("button")).click();
    ...
    @Test
    void shouldCardFormInvalidNoName() throws InterruptedException { //не указано имя
    ...
    @Test
    void shouldCardFormInvalidNoPhone() throws InterruptedException { //не указан номер телефона
    ...
    @Test
    void shouldCardFormInvalidCheckbox() throws InterruptedException { //чекбокс не выбран
